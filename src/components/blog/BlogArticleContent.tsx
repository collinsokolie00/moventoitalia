...
export default function BlogArticleContent({ content }: { content: string }) {
  ...
  return <div className="max-w-none bg-white text-base leading-7 text-slate-700 sm:text-lg sm:leading-8 [&_a]:text-blue-700 [&_blockquote]:my-8 [&_blockquote]:border-l-4 [&_blockquote]:border-blue-500 [&_blockquote]:bg-blue-50 [&_blockquote]:px-6 [&_blockquote]:py-4 [&_figcaption]:mt-2 [&_figcaption]:text-center [&_figcaption]:text-sm [&_figcaption]:text-slate-500 [&_figure]:my-10 [&_h2]:mb-5 [&_h2]:mt-12 [&_h2]:text-2xl [&_h2]:font-extrabold [&_h2]:tracking-tight [&_h2]:text-slate-950 sm:[&_h2]:text-3xl [&_h3]:mb-4 [&_h3]:mt-10 [&_h3]:text-xl [&_h3]:font-extrabold [&_h3]:text-slate-950 sm:[&_h3]:text-2xl [&_img]:w-full [&_img]:rounded-3xl [&_li]:my-2 [&_li]:text-slate-700 [&_ol]:my-6 [&_ol]:list-decimal [&_ol]:pl-7 [&_p]:my-6 [&_p]:text-slate-700 [&_ul]:my-6 [&_ul]:list-disc [&_ul]:pl-7">{blocks}</div>;
}
